...
Route::group(['middleware' => ['auth','admin_access','switch_lang']], function () {
    ...
    Route::get('/admin/homepage/edit/{id}', 'VenController@show')->name('VenController.show');
    Route::get('/admin/about/edit/{id}', 'VenstoryController@show')->name('VenstoryController.show');
    Route::get('/admin/team/edit/{id}', 'VenteamController@show')->name('VenteamController.show');

    Route::post('/admin/homepage/save/{id}', 'VenController@save')->name('VenController.save');
    Route::post('/admin/about/save/{id}', 'VenstoryController@save')->name('VenstoryController.save');
    Route::post('/admin/team/save/{id}', 'VenteamController@save')->name('VenteamController.save');
