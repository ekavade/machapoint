...
Route::get('/vendorhome/create', 'VenController@create')->name('vendorhome.create');
Route::get('/vendorstory/create', 'VenstoryController@create')->name('vendorstory.create');
Route::get('/vendorteam/create','VenteamController@create')->name('vendorteam.create');
Route::get('/vendorsupport/create','VensupportController@create')->name('vendorsupport.create');

Route::post('/vendorhome', 'VenController@store')->name('vendorhome.store');
Route::post('/vendorstory', 'VenstoryController@store')->name('vendorstory.store');
Route::post('/vendorteam', 'VenteamController@store')->name('vendorteam.store');
Route::post('/vendorsupport', 'VensupportController@store')->name('vendorsupport.store');
...
Route::group(['middleware' => ['web','switch_lang']], function () {
    ...
    Route::group(['middleware' => ['maintainence_mode']], function () {
            ...
            Route::group(['middleware' => ['IsInstalled', 'is_verified', 'isActive', 'two_fa','switch_lang']], function () {
                ...
                Route::get('/shop-products','Web\HomeController@newHomepage')->name('mainindex')->middleware('visiting_track');

                Route::get('/','Web\DiscoverController@discoverpage');

                Route::get('/stories/{id}', 'Web\StoriesController@index');
                
                Route::get('/profile/home/{id}', 'Web\ProfileController@home');
                
                Route::get('/profile/story/{id}', 'Web\ProfileController@story');
                
                Route::get('/profile/products-services/{id}', 'Web\ProfileController@productsServices');
                ...
                Route::get('/story/like/{id}','StoryLikeController@like');

                Route::get('/story/view/{id}','StoryViewController@view');

                Route::get('/story/unlike/{id}','StoryLikeController@unlike');
            ...
            Route::get('/shopcat', 'MainController@categoryfcat')->name('filtershopcat')->middleware('switch_lang');
