...
@section('title',__('Create Support Page for Startup | '))
@section('body')
@component('admin.component.breadcumb',['thirdactive' => 'active'])

@slot('heading')
{{ __('Add Support Members For Startup') }}
@endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('Add Support section') }}</h5>
                </div>
                <div class="card-body ml-2">
                    <!-- main content start -->
                    <form action="{{ route("vendorsupport.store") }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                                    ...
                                    <textarea placeholder="{{ __("Enter Content") }}" class="editor" name="descr"
                                    id="descr" cols="30" rows="10"></textarea>
