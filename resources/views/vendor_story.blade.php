        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('Create New Story') }}</h5>
                </div>
                <div class="card-body ml-2">
                    <!-- main content start -->
                    <form action="{{ route("vendorstory.store") }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <textarea placeholder="{{ __("Enter Content") }}" class="editor" name="quote"
                                    id="quote" cols="30" rows="10"></textarea>
                               ...
                               <input type="text" name="word1" id="word1" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="text-dark">{{ __("word 2 : ") }}<span
                                        class="text-danger">*</span></label>
                               <input type="text" name="word2" id="word2" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="text-dark">{{ __("word 3 : ") }}<span
                                        class="text-danger">*</span></label>
                               <input type="text" name="word3" id="word3" class="form-control">
                                </div>
