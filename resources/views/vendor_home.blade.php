...
@section('title',__('Create Home Page for Startup | '))
@section('body')
@component('admin.component.breadcumb',['thirdactive' => 'active'])

@slot('heading')
{{ __('Add Home Page For Startup') }}
@endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body ml-2">
                    <!-- main content start -->
                    <form action="{{ route('vendorhome.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{ __('Enter Number 1') }}" name="num1" />

                            <label class="text-dark">{{ __("Sign 1 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Sign for Number 1') }}" name="sign1"/>

                            <label class="text-dark">{{ __("Name 1 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Name for Number 1') }}" name="name1"/>
                        </div>

                        <div class="form-group">
                            <label class="text-dark">{{ __("Number 2 : ") }}<span class="text-danger">*</span></label>
                            <input type="text" placeholder="{{ __('Enter Number 2') }}" name="num2"  />

                            <label class="text-dark">{{ __("Sign 2 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Sign for Number 2') }}" name="sign2"/>

                            <label class="text-dark">{{ __("Name 2 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Name for Number 2') }}" name="name2"/>
                        </div>

                        <div class="form-group">
                            <label class="text-dark">{{ __("Number 3 : ") }}<span class="text-danger">*</span></label>
                            <input type="text" placeholder="{{ __('Enter Number 3') }}" name="num3" />

                            <label class="text-dark">{{ __("Sign 3 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Sign for Number 3') }}" name="sign3"/>

                            <label class="text-dark">{{ __("Name 3 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Name for Number 3') }}" name="name3"/>
                        </div>

                        <div class="form-group">
                            <label class="text-dark">{{ __("Number 4 : ") }}<span class="text-danger">*</span></label>
                            <input type="text" placeholder="{{ __('Enter Number 4') }}" name="num4" />

                            <label class="text-dark">{{ __("Sign 4 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Sign for Number 4') }}" name="sign4"/>

                            <label class="text-dark">{{ __("Name 4 : ") }}<span class="text-danger"></span></label>
                            <input type="text" placeholder="{{ __('Enter Name for Number 4') }}" name="name4"/>
                        </div>
                        <div class="form-group">
