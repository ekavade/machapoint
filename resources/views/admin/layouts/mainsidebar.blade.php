<div class="leftbar">
            ...
            <ul class="vertical-menu">
              ...
              <li class="{{ Nav::isRoute('admin.main') }}">
                <a href="{{ route('admin.main') }}">
                                <i class="feather icon-airplay" aria-hidden="true"></i>
                ...
                @canany(['stores.accept.request','stores.view'])
                  <li class="{{ Nav::isRoute('get.store.request') }} {{ Nav::isResource('stores') }}">
                    ...
                    <ul class="vertical-submenu">
                      ...
                      @endcan
                                @can('stores.view')
                                <li class="{{ Nav::isResource('stores Homepage') }}">
                                    <a href="{{route('vendorhome.create')}} ">
                                        {{__('Stores Homepage')}}
                                    </a>
                                </li>
                                @endcan
                                <li class="{{ Nav::isResource('stores Storypage') }}">
                                    <a href="{{route('vendorstory.create')}} ">
                                        {{__('Stores Story')}}
                                    </a>
                                </li>
                                <li class="{{ Nav::isResource('stores Storypage') }}">
                                    <a href="{{route('vendorteam.create')}} ">
                                        {{__('Add Team Members')}}
                                    </a>
                                </li>
                                <li class="{{ Nav::isResource('stores Storypage') }}">
                                    <a href="{{route('vendorsupport.create')}} ">
                                        {{__('Add Supports')}}
                                    </a>
                                </li>
              ...
              @canany(['review.view','brand.view','category.view','subcategory.view','childcategory.view','products.view','products.import','attributes.view','coupans.view','returnpolicy.view','units.view','specialoffer.view'])
                  ...
                  <ul class="vertical-submenu">
                    @can('brand.view')
                                <li class="{{ Nav::isResource('brand') }}"><a
                                        href="{{url('admin/brand')}} ">{{ __('Brands') }}</a></li>
                    @if($genrals_settings->vendor_enable == 1)
                                <li class="{{ Nav::isRoute('requestedbrands.admin') }}"><a
                                        href="{{route('requestedbrands.admin')}} ">{{ __('Requested Brands') }}
                      ...
                      <ul class="vertical-submenu">
                        ...
                        <li
                          class="{{ Nav::isRoute('category.index') }} {{ Nav::isRoute('category.create') }} {{ Nav::isRoute('category.edit') }}">
                                            <a href="{{url('admin/category')}}">{{ __('Categories') }}</a>
                                        </li>
                        @endcan
                        @can('subcategory.view')
                                        <li class="{{ Nav::isResource('subcategory') }}"><a
                                                href="{{url('admin/subcategory')}}">{{ __('Subcategories') }}</a></li>
                        @endcan
                        @can('childcategory.view')
                                        <li class="{{ Nav::isResource('grandcategory') }}"><a
                                                href="{{url('admin/grandcategory')}}">{{ __('Childcategories') }}</a>
                                        </li>
                        @endcan
                      </ul>
                    </li>
                    ...
                    <li
                      class="{{ Nav::isRoute('pro.vars.all') }} {{ Nav::isResource('products') }} {{ Nav::isRoute('add.var') }} {{ Nav::isRoute('manage.stock') }} {{ Nav::isRoute('edit.var') }}">
                                    <a href="{{url('admin/products')}} ">{{ __('Variant Products') }} </a>
                                </li>
                    @endcan
                    @can('products.view')
                    ...
                    @endcan
                    @can('products.import')
                                <li class="{{ Nav::isRoute('import.page') }}"><a
                                        href="{{ route('import.page') }}">{{ __('Import Products') }}</a></li>
                    @endcan

                    @can('attributes.view')
                    <li
                      class="{{ Nav::isRoute('pro.val') }} {{ Nav::isRoute('opt.edit') }} {{ Nav::isRoute('attr.add') }}{{ Nav::isRoute('attr.index') }}">
                                    <a href="{{route('attr.index')}} ">{{ __('Product Attributes') }}</a>
                                </li>
                    @endcan
                    @can('coupans.view')
                                <li class="{{ Nav::isResource('coupan') }}"><a
                                        href="{{url('admin/coupan')}} ">Coupons</a></li>
                    @endcan
                    @can('returnpolicy.view')
                                <li class="{{ Nav::isResource('admin/return-policy') }}"><a
                                        href="{{url('admin/return-policy')}} ">{{ __('Return Policy Settings') }}</a>
                                </li>
                    @endcan
                    @can('units.view')
                                <li class="{{ Nav::isResource('unit') }}"><a
                                        href="{{url('admin/unit') }}">{{ __('Units') }}</a></li>
                    @endcan
                    @can('specialoffer.view')
                                <li class="{{ Nav::isResource('special') }}"><a
                                        href="{{ url('admin/special') }}">{{ __('Special Offers') }}</a></li>
                    @endcan

                    @can('review.view')
                                <li class="{{ Nav::isRoute('review.index') }}"><a
                                        href="{{url('admin/review')}}">{{ __('All Reviews') }}</a></li>

                                <li class="{{ Nav::isRoute('r.ap') }}"><a
                                        href="{{url('admin/review_approval')}}">{{ __('Reviews For Approval') }}</a>
                                </li>
                    @endcan
                ...
                <li id="reppro" class="{{ Nav::isRoute('get.rep.pro') }}">
                  <a href="{{ route('get.rep.pro') }}">
                                <i class="feather icon-alert-circle"
                                    aria-hidden="true"></i><span>{{ __('Reported Products') }}</span></a>
                </li>
              @endcan
              ...
              @canany(['order.view','invoicesetting.view'])
                <li id="ordersm"
                  ...
                  <a href="javaScript:void();">
                                <i class="feather icon-shopping-cart" aria-hidden="true"></i>
                  ...
                  <ul class="vertical-submenu">
                                ...
                                <li class="{{ Nav::isResource('order') }}"><a
                                        href="{{route('order.index')}} ">{{ __('All Orders') }}</a></li>
                                <li class="{{ Nav::isRoute('admin.preorders') }}"><a
                                        href="{{route('admin.preorders')}}"></i>{{__('Pre Orders')}} </a></li>
                                <li class="{{ Nav::isResource('admin.pending.orders') }}"><a
                                        href="{{route('admin.pending.orders')}}"></i>{{__('Pending Orders')}} </a></li>
                                <li class="{{ Nav::isRoute('admin.can.order') }}"><a
                                        href="{{route('admin.can.order')}}"></i>{{__('Canceled Orders')}} </a></li>

                                <li
                                    class="{{ Nav::isRoute('return.order.index') }} {{ Nav::isRoute('return.order.show') }} {{ Nav::isRoute('return.order.detail') }}">
                                    <a href="{{route('return.order.index')}} ">{{ __('Returned Orders') }}</a>
                                </li>
                    @can('invoicesetting.view')
                                <li class="{{ Nav::isResource('invoice') }}"><a
                                        href="{{url('admin/invoice')}}">{{ __('Invoice Setting') }}</a></li>
                    @endcan

                    @can('invoicesetting.view')
                                <li class="{{ Nav::isRoute('get.invoice.design') }}"><a
                                        href="{{route('get.invoice.design')}}">{{ __('Invoice Design') }}</a></li>
                    @endcan

                                <li class="{{ Nav::isResource('admin/rma') }}"><a
                                        href="{{route('rma.index')}} ">{{ __('Return Reasons') }}</a>
                    </li>
                  </ul>
                </li>
              @endcan
              ...
              @canany(['order.view'])
                        <li
                            class="{{ Nav::isResource('offline-orders') }} {{ Nav::isRoute('offline.orders.reports') }}">

                  <a href="javaScript:void();">
                                <i class="feather icon-shopping-cart"
                                    aria-hidden="true"></i><span>{{ __("Inhouse orders") }}</span>
                    <i class="feather icon-chevron-right"></i>
                  </a>
                ...
                {{ Nav::isResource('tax') }}">
                  ...
                  <a href="javaScript:void();">
                                <i class="feather icon-truck"
                                    aria-hidden="true"></i><span>{{ __('Shipping & Taxes') }}</span>
                    <i class="feather icon-chevron-right"></i>
                  </a>
                  @endcan
                  @can('taxsystem.manage')
                  <ul class="vertical-submenu">
                                <li class="{{ Nav::isResource('tax_class')  }}"><a
                                        href="{{url('admin/tax_class')}}">{{  __('Tax Classes') }}</a></li>
                                <li
                                    class="{{ Nav::isRoute('tax.index') }}{{ Nav::isRoute('tax.edit') }}{{ Nav::isRoute('tax.create') }}">
                                    <a href="{{url('admin/tax')}}">{{ __('Tax Rates') }}</a>
                                </li>
                                <li class="{{ Nav::isResource('admin/zone') }}"><a
                                        href="{{url('admin/zone')}}">{{ __('Zones') }}</a></li>
                                <li class="{{ Nav::isResource('shipping') }}"><a
                                        href="{{url('admin/shipping')}}">{{ __('Shipping') }}</a></li>
                  </ul>
                  @endcan
                </li>
              @endcan
              ...
              @can('sellerpayout.manage')
                ...
                <li
                  ...
                  <ul class="vertical-submenu">
                                ...
                                <li class="{{ Nav::isRoute('seller.payouts.index') }}"><a
                                        href="{{route('seller.payouts.index')}} ">{{ __('Pending Payouts') }}</a></li>

                                <li
                                    class="{{ Nav::isRoute('seller.payout.show.complete') }} {{ Nav::isRoute('seller.payout.complete') }}">
                                    <a href="{{ route('seller.payout.complete') }}">
              ...
              @canany(['hotdeals.view','blockadvertisments.view','advertisements.view','testimonials.view','offerpopup.setting','pushnotification.settings'])
                        <li
                            class="{{ Nav::isResource('flash-sales') }} {{ Nav::isRoute('admin.push.noti.settings') }} {{ Nav::isRoute('offer.get.settings') }} {{ Nav::isResource('testimonial') }} {{ Nav::isResource('adv') }} {{ Nav::isResource('hotdeal') }} {{ Nav::isResource('detailadvertise') }}">
                  <a href="javaScript:void();">
                                <i class="feather icon-bar-chart-line-"
                                    aria-hidden="true"></i><span>{{ __('Marketing Tools') }}</span>
                    <i class="feather icon-chevron-right"></i>
                  </a>

                  <ul class="vertical-submenu">
                    @can('hotdeals.view')
                                <li><a class="{{ Nav::isResource('admin/hotdeal') }}"
                                        href="{{url('admin/hotdeal')}}">{{ __('Hot Deals') }}</a></li>
                    @endcan
                    @can('blockadvertisments.view')
                                <li class="{{ Nav::isResource('admin/detailadvertise') }}"><a
                                        href="{{url('admin/detailadvertise')}}">{{ __('Block Advertisments') }}</a></li>
                    @endcan
                    @can('advertisements.view')
                                <li class="{{ Nav::isResource('admin/adv') }}"><a
                                        href="{{url('admin/adv')}}">{{ __('Advertisements') }}</a></li>
                    @endcan
                    @can('testimonials.view')
                                <li class="{{ Nav::isResource('admin/testimonial') }}"><a
                                        href="{{url('admin/testimonial')}} ">{{ __('Testimonials') }}</a></li>
                    @endcan
                    @can('offerpopup.setting')
                                <li class="{{ Nav::isRoute('offer.get.settings') }}"><a
                                        href="{{route('offer.get.settings')}} ">{{ __('Offer PopUp Settings') }}</a>
                                </li>
                    @endcan
                    @can('pushnotification.settings')
                    <li class="{{ Nav::isRoute('admin.push.noti.settings') }}"><a
                                        href="{{route('admin.push.noti.settings')}}">{{ __('Push Notifications') }}</a>
                                </li>
                    @endcan
              ...
              @can('wallet.manage')
                        <li class="{{ Nav::isRoute('admin.wallet.settings') }}"><a
                                href="{{ route('admin.wallet.settings') }}"><i class="feather icon-briefcase"
                                    aria-hidden="true"></i><span>{{ __('Wallet') }}</span></a></li>
              @endcan
              ...
              @can('reports.view')
                        <li
                            class="{{ Nav::isRoute('device.logs') }} {{ Nav::isRoute('admin.report.mostviewed') }} {{ Nav::isRoute('admin.stock.report') }} {{ Nav::isRoute('admin.sales.report') }}">
                  <a href="javaScript:void();">
              ...
              @can('menu.view')
                <li id="menum" class="{{ Nav::isResource('admin/menu') }}">
                  <a href="{{ route('menu.index') }}">
                                <i class="feather icon-sliders" aria-hidden="true"></i>
              ...
              @can('location.manage')
                <li id="location"
                  ...
                  <ul class="vertical-submenu">
                                <li class="{{ Nav::isResource('country') }}"><a
                                        href="{{url('admin/country')}}">{{ __('Countries') }}</a></li>
                                <li class="{{ Nav::isResource('state') }}"><a
                                        href="{{url('admin/state')}}">{{ __('States') }}</a></li>
                                <li class="{{ Nav::isResource('city') }}"><a
                                        href="{{url('admin/city')}}">{{ __('Cities') }}</a></li>
                                <li class="{{ Nav::isRoute('country.list.pincode') }}{{ Nav::isRoute('admin.desti') }}">
                                    <a href="{{url('admin/destination')}}">{{ __('Delivery Locations') }}</a>
                                </li>
                  </ul>
  ...
  <li
    ...
    <ul class="vertical-submenu">
      ...
      @can('sliders.manage')
                                <li id="slider"
                                    class="treeview {{ Nav::isRoute('front.slider') }} {{ Nav::isResource('slider') }}">
        <a href="#"><span>Sliders</span>
          <i class="feather icon-chevron-right"></i>
        </a>
        <ul class="vertical-submenu">
                                        <li class="{{ Nav::isResource('slider') }}"><a
                                                href="{{url('admin/slider')}} ">{{ __('Sliders') }}</a></li>
          <li class="{{ Nav::isRoute('front.slider') }}">
                                            <a
                                                href="{{route('front.slider')}} "><span>{{ __('Top Category Slider') }}</span></a>
          </li>
        </ul>
      </li>
      @endcan
      ...
      @can('pwasettings.manage')
                                <li class="{{ Nav::isRoute('pwa.setting.index') }}"><a
                                        title="{{ __('Progressive Web App Setting') }}"
      ...
      @can('faq.view')
                                <li id="faqs" class="{{ Nav::isResource('faq') }}"><a
                                        href="{{url('admin/faq')}} "><span>{{ __('FAQ\'s') }}</span></a>
      </li>
      @endcan
      ...
      <li class="{{ Nav::isRoute('widget.setting') }}">
                                    ...
                                    <a
                                        href="{{ route('widget.setting') }}"><span>{{ __('Widgets Settings') }}</span></span></a>
      ...
      <li class="{{ Nav::isRoute('payment.gateway.settings') }}">
                                    ...
                                    <a
                                        href="{{ route('payment.gateway.settings') }}"><span>{{ __('Payment Gateway Settings') }}</span></a>
      ...
      <li class="{{ Nav::isRoute('manual.payment.gateway') }}">
                                    ...
                                    <a
                                        href="{{ route('manual.payment.gateway') }}"><span>{{ __("Offline Payment Gateway") }}</span></a>
      ...
      <li class="{{ Nav::isRoute('customstyle') }}">
                                    <a
                                        href="{{ route('customstyle') }}"><span>{{ __('Custom Style and JS') }}</span></a>
      </li>
      @endcan

      @can('site-settings.footer-customize')
                                <li class="{{ Nav::isRoute('footer.index') }}"><a
                                        href="{{url('admin/footer')}} ">{{ __("Footer Customizations") }}</a></li>
      @endcan

      @can('site-settings.social-handle')
                                <li class="{{ Nav::isResource('social') }}"><a
                                        href="{{url('admin/social')}} ">{{ __('Social Handler Settings') }}</a></li>
      @endcan

      @can('blog.view')
                                <li class="{{ Nav::isResource('blog') }}"><a
                                        href="{{url('admin/blog')}}">{{ __('Blogs') }}</a></li>
      @endcan

      @can('pages.view')
                                <li class="{{ Nav::isResource('page') }}"><a
                                        href="{{url('admin/page')}}">{{ __('Pages') }}</a>
      </li>
      @endcan
                        ...
                        <li id="sitesetting"
                            class="{{ Nav::isResource('admin/seo-directory') }} {{ Nav::isRoute('get.user.terms') }} {{ Nav::isRoute('sms.settings') }}
    ...
    <a href="javaScript:void();">
                                <i class="feather icon-grid"
                                    aria-hidden="true"></i><span>{{ __('Site Settings') }}</span>
      <i class="feather icon-chevron-right"></i>
    </a>
    <ul class="vertical-submenu">

      @can('site-settings.genral-settings')
                                <li class="{{ Nav::isRoute('genral.index') }}"><a
                                        href="{{url('admin/genral')}}">{{ __('General Settings') }}</a></li>
      @endcan

      @can('seo.manage')
      <li class="{{ Nav::isRoute('seo.index') }}"><a href="{{url('admin/seo')}} ">SEO</a></li>
                                <li class="{{ Nav::isResource('admin/seo-directory') }}"><a
                                        href="{{route('seo-directory.index')}} ">{{ __('SEO directory') }}</a></li>
      @endcan
      ...
      @can('site-settings.mail-settings')
                                <li class="{{ Nav::isRoute('mail.getset') }}"><a
                                        href="{{url('admin/mail-settings')}}">{{ __('Mail Settings') }}</a></li>
      @endcan

      @can('site-settings.social-login-settings')
                                <li class="{{ Nav::isRoute('gen.set') }}"><a
                                        href="{{route('gen.set')}}">{{ __('Social Login Settings') }}</a></li>
      @endcan

      @can('site-settings.sms-settings')
                                <li class="{{ Nav::isRoute('sms.settings') }}"><a
                                        href="{{route('sms.settings')}}">{{ __('SMS Settings') }}</a></li>
      @endcan

      @can('site-settings.dashboard-settings')
      <li class="{{ Nav::isRoute('admin.dash') }}">
                                    <a
                                        href="{{ route('admin.dash') }}"><span>{{ __('Admin Dashboard Settings') }}</span></a>
      </li>
      @endcan
      ...
      <li class="{{ Nav::isRoute('get.view.m.mode') }}">
                                    <a
                                        href="{{ route('get.view.m.mode') }}"><span>{{ __("Maintenance Mode") }}</span></a>
      </li>
      @endcan
      ...
      @can('site-settings.bank-settings')
                                <li class="{{ Nav::isResource('admin/bank_details') }}"><a
                                        href="{{url('admin/bank_details')}} "></i><span>{{ __('Bank Details') }}</span></a>
                                </li>
      @endcan
      ...
      @endcan
                        ...
                        <li class="{{ Nav::isRoute('media.manager') }}"><a href="{{ route('media.manager') }}"><i
                                    class="feather icon-image"
                                    aria-hidden="true"></i><span>{{ __("Media Manager") }}</span></a></li>
                        @endcan

                        @can('chat.manage')
  <li id="ticket" class="{{ Nav::hasSegment(['chats','chat']) }}">
    <a href="{{ route('admin.chat.list') }}">
                                <i class="feather icon-message-circle"
                                    aria-hidden="true"></i><span>{{ __("My Chats") }}</span></a>
  </li>
                        @endcan

                        @can('addon-manager.manage')
                        <li class="{{ Nav::isRoute('addonmanger.index') }}"><a href="{{route('addonmanger.index')}} "><i
                                    class="feather icon-download"></i><span>{{ __("Add-on Manager") }} <small
                                        class="badge badge-success float-right">{{ __('NEW') }}</small></span>
    </a>
  </li>
                        @endcan
              ...
              @can('support-ticket.manage')
                ...
                <li id="ticket" class="{{ Nav::isRoute('tickets.admin') }} {{ Nav::isRoute('ticket.show') }}">
                  <a href="{{ route('tickets.admin') }}">
                                <i class="feather icon-volume-1"
                                    aria-hidden="true"></i><span>{{ __('Support Tickets') }}</span></a>
                </li>
                ...
                <li
                  ...
                  <a href="javaScript:void();">
                                <i class="feather icon-help-circle"
                                    aria-hidden="true"></i><span>{{ __('Help & Support') }}</span>
                    <i class="feather icon-chevron-right"></i>
                  </a>
                  <ul class="vertical-submenu">
                    ...
                    <li id="reppro" class="{{ Nav::isRoute('admin.backup.settings') }}">
                                    <a
                                        href="{{ route('admin.backup.settings') }}"><span>{{ __('Database Backup') }}</span></a>
                    </li>
                    @endcan
