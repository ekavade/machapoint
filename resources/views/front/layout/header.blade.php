							...
							<li class="myaccount"><a href="{{url('profile')}}"
								...
								<li class="check"><a data-toggle="modal" href="#feeddesk"
									...
									<div class="main-header">
										<div class="container-fluid">
											<div class="row">
												<div class="col-6  col-md-3 col-sm-3 col-lg-3 logo-holder">
													<!-- ============ LOGO ========================================= -->
													<div class="logo"> <a href="{{url('/')}}" title="{{$title}}"> <img height="23px"
														style="margin-top: 20px" src="{{url('images/genral/'.$front_logo)}}" alt="logo"> </a> </div>
														<!-- /.logo -->
														<!--=================== LOGO : END ================= -->
													</div>
													<!-- /.logo-holder -->

													<div class="col-lg-6 col-md-6 col-sm-6 col-12 top-search-holder">
														<!-- ====================== SEARCH AREA ======================== -->
															...
															<ul class="nav">
																...
																<ul class="nav flex-column flex-nowrap overflow-hidden">
																	...
																	<li class="nav-item">
																		...
																		<div class="row">
																			<div class="col-12">
																				<a href="javascript:topProfiles()" class="nav-link text-truncate">
																	...
																	<li class="nav-item">
																		<div class="row">
																			<div class="col-12">
																				<a href="javascript:recentlyAdded()" class="nav-link text-truncate" >
																	...
																	<li class="nav-item">
																		<div class="row">
																			<div class="col-12">
																				<a href="javascript:yourInterests()" class="nav-link text-truncate" >
																	...
																	<li class="nav-item">
																		<div class="row">
																			<div class="col-12">
																				<a href="javascript:favorites()" class="nav-link text-truncate" >
