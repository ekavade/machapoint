...
class StoreController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $stories = story::where('store_id', $store->id)->get();

        return view("admin.store.edit", compact("store", "countrys", "states", "citys", "users", 'storeordercount','stories','allstore','category'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($file = $request->file('store_logo_rect')) {

            if ($store->store_logo_rect != null) {

                if (file_exists(public_path() . '/images/store/' . $store->store_logo_rect)) {
                    unlink(public_path() . '/images/store/' . $store->store_logo_rect);
                }
