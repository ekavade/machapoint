...
class MainController extends Controller
{
    ...
    public function categoryfcat(Request $request)
    {
        ...
        $category_entries = Store::where('cat_id', $request->category)->get();
        $category_titles = Category::where('id', $request->category)->first();

        return view('front.filters.categorystore', compact('category_entries','category_titles','outofstock', 'ratings', 'start_rat', 'a', 'start_price', 'tag_check', 'brand_names', 'conversion_rate', 'products', 'simple_products' , 'catid', 'sid', 'chid', 'start', 'end', 'starts', 'ends', 'tag', 'tags_pro', 'slider'));
    }
